      ...
      <div className="pt-4">
        <div className="bg-white rounded-[20px] p-5">
          ...
          <div className="mt-4 space-y-4">
            <div>
              <p className="text-[13px] font-bold text-[#0B1320] mb-1">1. Use of Service</p>
            ...
            <div>
              <p className="text-[13px] font-bold text-[#0B1320] mb-1">2. Data Privacy</p>
              <p className="text-[12px] text-gray-400 font-medium leading-relaxed">
                Your financial data is stored locally on your device. We do not share your information with third parties.
              </p>
            </div>
            <div>
              <p className="text-[13px] font-bold text-[#0B1320] mb-1">3. Accuracy</p>
              <p className="text-[12px] text-gray-400 font-medium leading-relaxed">
